...
module.exports = function(RED) {
    ...
    function IOTFBrokerNode(n) {
        ...
        if (this.brokerurl == "") {
            ...
            if (this.broker != "") {
                ...
                this.brokerurl = this.brokerurl+"imaserver:1884";
            }
        }
    ...
    RED.nodes.registerType("iotc-broker-in",IOTFBrokerNode,{
        credentials: {
            user: {type:"text"},
    ...
    function IOTFInNode(n) {
        ...
        if (this.brokerConn) {
            ...
            if (this.topic) {
                ...
                this.error(RED._("iotc.errors.not-defined"));
            }
            this.on('close', function(done) {
                if (node.brokerConn) {
    ...
    RED.nodes.registerType("iotc in",IOTFInNode);
};
